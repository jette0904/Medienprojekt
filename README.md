...
`pnpm dev` startet den Live server, dann kannst du einfach mit Cmd + Klick auf die http Adresse in der Konsole klicken.

`pnpm lint:fix` lässt linter drüber laufen. Er versucht schon so viel wie er kann selber zu fixen.
# Medienprojekt
